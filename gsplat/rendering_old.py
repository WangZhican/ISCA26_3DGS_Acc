...
def rasterization(
    ...
    project_only_time = time.time()-cur_time_1
    ...
    if sh_degree is None:
        ...
        project_time = time.time()-cur_time_1
    ...
    sort_time = time.time()-cur_time_2
...
def _rasterization(
    ...
    project_time = time.time()-cur_time
    opacities = opacities.repeat(C, 1)  # [C, N]
    camera_ids, gaussian_ids = None, None
